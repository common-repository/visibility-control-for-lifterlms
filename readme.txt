...
Donate link:
Tags: Lifter, eLearning, LMS, Hide, Hide Content, Hide Message
...
- [Visibility Control for WPCourseware LMS](https://www.nextsoftwaresolutions.com/visibility-control-for-wp-courseware/)
...
- [Visibility Control for MasterStudy LMS](https://www.nextsoftwaresolutions.com/visibility-control-for-masterstudy/)
...
- [Experience API for LifterLMS](https://www.nextsoftwaresolutions.com/experience-api-for-lifterlms/)
...
1. Upload the plugin files to the `/wp-content/plugins/visibility-control-for-lifterlms` directory, or install the plugin through the WordPress plugins screen directly.
...
Lifter LMS is a popular WordPress based Learning Management System (LMS) plugin. It includes many advanced features including, quizzing engine, course management, reports, certificates and payment methods.

You can also add GrassBlade xAPI Companion plugin and GrassBlade LRS to start using Experience API (xAPI) based contents with Lifter LMS.
...
= 1.1 =
* Fixed: Hidden elements showing for a moment before being hidden.
